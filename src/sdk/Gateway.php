...
class Gateway
{
    ...
    public function request(string $apiNo, array $param, array $extra = []): array
    {
        ...
        $params = [
            ...
            'encryptKey' => (new RtSm2('base64'))->doEncrypt($secret, $this->config['sopPublicKey'], C1C2C3),
        ...
        // SM2解密
        $secret = (new RtSm2('base64'))->doDecrypt($data['encryptKey'], $this->config['mchPrivateKey']);
        if (empty($secret)) {
    ...
    public function notify(array $param): array
    {
        ...
        // SM2解密
        $secret = (new RtSm2('base64'))->doDecrypt($param['encryptKey'], $this->config['mchPrivateKey']);
        if (empty($secret)) {
            return Helper::return(1003);
        }
        // SM4解密
